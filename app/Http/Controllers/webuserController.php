...
class webuserController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ticket_solution']=issues::with(['category','priority','request','assign_it_support_relation','assign_it_ops_relation'])->where([['request_id','=',$user->id],['status','=','SLITSP']])->orWhere([['status','=','SLITOPS']])->get();
